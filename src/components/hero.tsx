    ...
    <div className='p-4 lg:px-6 xl:px-10p'>
      <div className='flex  items-center justify-between'>
        ...
        <div className='hidden md:flex overflow-hidden gap-5'>
          <Button variant='heroLarge' >
            label='Project'
          </Button>
          <Button variant='heroSmall'>
      ...
      <div className='flex md:mt-5 justify-end md:justify-between'>
        {/* description */}
        <p className='text-lg md:mt-3 hidden md:block leading-6 font-open-sans text-light-gray'>
          My goal is to <span className='font-fira-code text-foreground'>write maintainable, clean</span> <br /> and <span className='font-fira-code text-foreground'>understandable code</span> to process <br />
          development was enjoyable
        </p>
        <h1 className='text-5xl mt-3 lg:text-8xl md:mt-0  xl:text-9xl font-fira-code md:text-7xl font-extrabold'>Developer</h1>
      </div>

      {/* description */}
      <p className='text-lg mt-6 md:hidden leading-6 font-open-sans text-light-gray'>
      ...
      {/* cta buttons */}
      <div className='mt-5 md:hidden flex overflow-hidden gap-5'>
      ...
      {/* socials links */}
      <div className='flex flex-wrap gap-3 mx-auto max-w-3xl md:justify-center mt-8'>
